...
class Owner:
    ...
    async def _set(self, ctx):
        """Changes Keeko's global settings."""
    ...
    async def serverprefix(self, ctx, *prefixes):
        """Sets Keeko's prefixes for this server
